    ...
    <button class="btn btn-primary" @click="logout">Logout</button>
      ...
      <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div>
            <span style="">{{msg}}</span><span><button @click="logout" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Logout</button></span>
            </div>
          </div>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{dashBoardData.TASKS}}%</div>
                        </div>
                        <div class="col">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">{{dashBoardData.PENDING_REQUEST}}</div>
                    </div>
                    <div class="col-auto">
...
export default {
  ...
  mounted() {
    ...
    if (localStorage.getItem('userDetails')) { 
      ...
      if(this.userDetails){
        this.msg="Hello "+this.userDetails.email+".";
      }else{
